...
class DataTransformation:
    ...
    def initaite_data_transformation(self) -> DataTransformationArtifact:
        logging.info("Entered Data Transformation phase using initiate_data_transforamtion method")
        try:
